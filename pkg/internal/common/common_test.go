...
func TestWaitUntilDeleted(t *testing.T) {
	...
	testhelper.NewGenericWaitUntilDeletedTestConfig(
		commonConfig, common.WaitUntilDeleted[corev1.Namespace, corev1.NamespaceList]).ExecuteTests(t)
}
...
func TestDeleteAndWait(t *testing.T) {
	...
	testhelper.NewGenericDeleteAndWaitTestConfig(
		commonConfig, common.DeleteAndWait[corev1.Namespace, corev1.NamespaceList]).ExecuteTests(t)
}
...
func TestWithOptions(t *testing.T) {
	...
	testhelper.NewGenericWithOptionsTestConfig(commonConfig, common.WithOptions).ExecuteTests(t)
}
