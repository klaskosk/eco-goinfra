...
// ListPointer is a constraint that requires a type be a pointer to L and implement the runtimeclient.ObjectList
// interface. This is the list equivalent of [ObjectPointer].
