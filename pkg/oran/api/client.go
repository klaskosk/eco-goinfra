...
// BuildAlarms creates a new AlarmsClient using the configuration set on this builder. If the builder has an error
// message, it will be returned here. This method does not modify the builder so the builder can be reused.
